...
-- 说明：
-- 1. 取消注释（删除 --）来启用快捷键
-- 2. <leader> 键默认是反斜杠 \，可以通过设置 vim.g.mapleader 修改
...
-- ============================================================================
-- Neo-tree 文件树快捷键（在 config/neotree.lua 中已配置）
-- ============================================================================
...
-- ============================================================================
-- Git 操作（需要安装 gitsigns.nvim）
-- ============================================================================

-- map("n", "<leader>gb", ":Gitsigns blame_line<CR>", opts("Git blame line"))
-- map("n", "<leader>gp", ":Gitsigns preview_hunk<CR>", opts("Preview hunk"))
-- map("n", "[g", ":Gitsigns prev_hunk<CR>", opts("Previous hunk"))
-- map("n", "]g", ":Gitsigns next_hunk<CR>", opts("Next hunk"))
